...
public class MainClient {
    public static void init() {
        ...
        RegistryClient.registerBlockRenderType(RenderType.cutout(), Blocks.MOSCOW_OLD_TICKET_BARRIER_SIDE_COVER.get());
        ...
        RegistryClient.registerBlockRenderType(RenderType.translucent(), Blocks.MOSCOW_NEW_TICKET_MACHINE.get());
